...
- Datasworn packages are not wired up yet. When they are: pin exact versions, keep them excluded
  from Renovate, and treat every bump as a content-model change with regenerated goldens.
